  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed bottom-6 right-6 h-16 w-16 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 z-50"
        size="icon"
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[500px] bg-card/95 backdrop-blur-xl border border-border rounded-2xl shadow-2xl z-50 flex flex-col animate-scale-in">
          {/* Header */}
